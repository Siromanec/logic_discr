...
class ALU_4_bit(AdvancedCircuitElement):
    ...
    def set_reaction_areas_for_pins(self):
        self.input_dict["A3"].set_reaction_area(-77, -65, -67, -55)
        self.input_dict["A2"].set_reaction_area(-58, -65, -48, -55)
        self.input_dict["A1"].set_reaction_area(-41, -65, -31, -55)
        self.input_dict["A0"].set_reaction_area(-22, -65, -12, -55)
        
        self.input_dict["B3"].set_reaction_area(18, -65, 28, -55)
        self.input_dict["B2"].set_reaction_area(37, -65, 47, -55)
        self.input_dict["B1"].set_reaction_area(54, -65, 64, -55)
        self.input_dict["B0"].set_reaction_area(74, -65, 84, -55)
        
        self.input_dict["Carry In"].set_reaction_area(-125, -31, -115, -21)
        self.input_dict["Borrow In"].set_reaction_area(-125, -11, -115, -1)
        self.input_dict["Select S1"].set_reaction_area(-125, 6, -115, 16)
        self.input_dict["Select S0"].set_reaction_area(-125, 25, -115, 35)

        self.output_dict["O3"].set_reaction_area(-31, 60, -21, 70)
        self.output_dict["O2"].set_reaction_area(-12, 60,  -2, 70)
        self.output_dict["O1"].set_reaction_area(5, 60,  15, 70)
        self.output_dict["O0"].set_reaction_area(24, 60,  34, 70)

        self.output_dict["Overflow Adder"].set_reaction_area(114, 3, 124, 13)
        self.output_dict["Overflow Substractor"].set_reaction_area(114, -16, 124, -6)
        ################
        # self.input_dict["A3"].set_reaction_area(-77, 56, -67, 65 )
        # self.input_dict["A2"].set_reaction_area(-58, 55, -48, 65)
        # self.input_dict["A1"].set_reaction_area(-41, 55, -31, 65)
        # self.input_dict["A0"].set_reaction_area(-22, 55, -12, 65)
        
        # self.input_dict["B3"].set_reaction_area(18, 55, 28, 65)
        # self.input_dict["B2"].set_reaction_area(37, 55, 47, 65)
        # self.input_dict["B1"].set_reaction_area(54, 55, 64, 65)
        # self.input_dict["B0"].set_reaction_area(74, 55, 84, 65)
        
        # self.input_dict["Carry In"].set_reaction_area(-125, 21, -115, 31)
        # self.input_dict["Borrow In"].set_reaction_area(-125, 1, -115, 11)
        # self.input_dict["Select S1"].set_reaction_area(-125, -16, -115, -6)
        # self.input_dict["Select S0"].set_reaction_area(-125, -35, -115, -25)

        # self.output_dict["O3"].set_reaction_area(-31, -70, -21, -60)
